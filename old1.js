...
const numberOfParticles = 10000; // Reduced for performance
...
class Particle {
  constructor(x, y, size, color) {
    ...
    this.alpha = Math.random() * 0.5 + 0.2; // Random alpha for fading effect
  }
...
function init() {
  ...
  for (let i = 0; i < numberOfParticles; i++) {
    ...
    const color = 'rgba(255, 255, 255, 0.9)'; // Light white color for stardust
...
//     const x = Math.random() * canvas.width;
//     const y = Math.random() * canvas.height;
//     const color = 'rgba(255, 230, 0, 0.9)'; // Light white color for stardust
//     particlesArray.push(new Particle(x, y, size, color));
//   }
// }
